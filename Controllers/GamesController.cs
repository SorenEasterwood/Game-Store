...
namespace Game_Store.Controllers
{
    public class GamesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("GameId,Title,Year,Rating,Cost")] Game game)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GameId,Title,Year,Rating,Cost")] Game game)
        {
            if (id != game.GameId)
            {
                return NotFound();
